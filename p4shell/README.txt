...
2. cp -r /stage/classes/archive/2021/fall/15400-1/proj/p4/test-scripts ./

or via the web:

  https://canvas.uchicago.edu/courses/37621/files/folder/Assignments?preview=6484698

   (now, you should have test-scripts folder under your p4shell)
...
Please put your latest total score of running grade.py to excpected-grade.txt before due.
